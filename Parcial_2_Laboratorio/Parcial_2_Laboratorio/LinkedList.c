...
{
    int retorno=-1;
    int cantPasajerosVuelo=0;
    int acumPasajerosTotal=0;

    if(this != NULL && pFunc != NULL)
    {
        for(int i=0;i<ll_len(this);i++)
        {
            cantPasajerosVuelo=pFunc(ll_get(this,i));
            acumPasajerosTotal=acumPasajerosTotal+cantPasajerosVuelo;
        }
        retorno=acumPasajerosTotal;
    }
